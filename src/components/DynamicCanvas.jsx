...
useEffect(() => {
  ...
  return (
    <div style={{overflowY: "hidden"}}>
       <div>
        <button className={"nextSectionButton"} style={{display: mobile ? "block" : "none",  textShadow: "2px 2px 5px black", borderRadius: "10px", padding: "10px", height: "10vh", backgroundColor: "#a1b4d4", top: "91vh", left: "36vw", position: "fixed", zIndex: 998}} onClick={() => handleClick()}>Next Section</button>
      </div>
